  ...
  return (
    <div className="px-5">
      <div className="mb-3 flex items-end justify-between">
        ...
        <button onClick={() => navigateTo("/schedule", "일정 확인으로 이동했어요")} className="pressable flex items-center text-muted-foreground mb-0.5" style={{ fontSize: '14px' }}>
              ...
              {days.map((d) => {
                ...
                return (
                  <div key={d.day} className="flex flex-1 flex-col items-center">
                    {d.isToday ? (
                      <div className="flex flex-col items-center justify-center bg-[hsl(var(--role-badge))]" style={{ width: 50, height: 54, borderRadius: 10 }}>
