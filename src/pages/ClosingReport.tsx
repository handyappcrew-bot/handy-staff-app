...
const ClosingReport = () => {
  ...
  const renderInput = (label: string, value: string, onChange: (v: string) => void, placeholder = "숫자만 입력") => (
    <div className="mb-6">
      ...
      <div className="flex items-center bg-white border border-[#E5E7EB] rounded-[12px] px-4 h-[52px] focus-within:border-[#4261FF] focus-within:shadow-[0_0_0_1px_#4261FF]" style={{ outline: 'none' }}>
        <input
          type="text"
          inputMode="numeric"
          ...
          data-no-focus="true" className="flex-1 bg-transparent text-[16px] text-[#292b2e] placeholder:text-[#c5c7ca] outline-none"
        />
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <>
            ...
            <div className="mb-6" style={{ boxSizing: 'border-box', width: '100%' }}>
              ...
              <div className="flex gap-3" style={{ boxSizing: 'border-box', width: '100%' }}>
                ...
                <div className="flex items-center bg-white border border-[#E5E7EB] rounded-[12px] h-[52px] px-4 focus-within:border-[#4261FF] focus-within:shadow-[0_0_0_1px_#4261FF]" style={{ flex: 1, minWidth: 0, boxSizing: 'border-box' }}>
                  <input
                    type="text"
                    inputMode="numeric"
                    ...
                    data-no-focus="true" className="flex-1 bg-transparent text-[16px] text-[#292B2E] placeholder:text-[#C5C7CA] outline-none min-w-0"
                  />
                  <span className="text-[16px] text-[#6B7280] ml-2">원</span>
                </div>
              </div>
              {cashDiffAmount && cashDiffType && (
                <p className="text-[13px] text-muted-foreground mt-1">
                  *현금이 {displayValue(cashDiffAmount)}원 더 {cashDiffType === "초과" ? "많아요" : "부족해요"}
                </p>
              )}
            </div>
          </>
      ...
      <ConfirmDialog open={showAlreadyDoneDialog} onOpenChange={() => {}} title="마감 보고 완료"
        description="오늘의 마감 보고는 완료 되었어요. 마감 보고는 하루에 한 번 가능해요."
