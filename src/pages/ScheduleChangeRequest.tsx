          ...
          <div className="px-5 pt-4">
            ...
            {selectedScheduleDate && selectedSchedule && (
              <div className="flex items-center gap-3 rounded-xl px-4 py-3" style={{ backgroundColor: '#F0F7FF' }}>
                <span style={{ borderRadius: '4px', padding: '4px 8px', fontSize: '13px', fontWeight: 500, backgroundColor: typeStyle[selectedSchedule.type].bg, color: typeStyle[selectedSchedule.type].text }}>{typeLabels[selectedSchedule.type]}</span>
